...
public class CacheUtil {
    public static final String KEY_MYACCOUNT = "lips_cache_myaccount";
     ...
     * @return
     */
    public static boolean saveCacheStream2SD(String path, String cacheKey, InputStream inStream) {
        if (!isSDCard()) {
            return false;
        }
        FileOutputStream fos = null;
    ...
    public static boolean saveCacheSerializable2SD(String path, String cacheKey, Object data) {
        FileOutputStream fos = null;
        ObjectOutputStream oos = null;
